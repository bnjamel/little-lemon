...
function Menu() {
  return <section className="menu pt-[72px]">
    ...
    <div className="container m-auto">
        {/* Starters */}
        <section id="starters" className="specials mt-[1rem] sm:mt-[1rem] container m-auto">
        ...
        {/* Soups and Salads */}
        <section id="soups" className="specials mt-[3rem] sm:mt-[6rem] container m-auto">
            <div className="specials__header flex justify-between mx-5 my-5">
            <h1 className="text-[21px] sm:text-[28px] md:text-[38px] font-bold">
                Soups and Salads
            </h1>
        ...
        {/* Pasta */}
        <section id="pasta" className="specials mt-[3rem] sm:mt-[6rem] container m-auto">
            <div className="specials__header flex justify-between mx-5 my-5">
            <h1 className="text-[21px] sm:text-[28px] md:text-[38px] font-bold">
            Pasta
            </h1>
        ...
        {/* Main Courses */}
        <section id="mainCourses" className="specials mt-[3rem] sm:mt-[6rem] container m-auto">
            <div className="specials__header flex justify-between mx-5 my-5">
            <h1 className="text-[21px] sm:text-[28px] md:text-[38px] font-bold">
                Main Courses
            </h1>
