    ...
    <section className=" flex justify-center items-center flex-col">
      <div className="container m-auto max-w-[500px] bg-[#495E57] rounded-lg px-5 pt-4 pb-12 drop-shadow-[0_5px_10px_rgba(0,0,0,0.25)]">
        ...
        <div>
          <Link
            to="#"
            className="flex justify-center items-center rounded-lg py-2 bg-white hover:bg-slate-100"
          >
            <img
              src={GoogleIcon}
              className="min-w-[30px] w-[30px] mr-5"
              alt=""
            />
          ...
          <Link
            to="#"
            className="flex justify-center items-center rounded-lg py-2 mt-3 bg-white hover:bg-slate-100"
          >
